...
public class Phonebook {
    public void addContact(ArrayList list) {
        ...
        while (true) {
            ...
            if (input.equals("q")) {
                ...
                System.out.println("q - Выход, Enter - продолжение");
                list.add(new Employees(id, inputPhone, inputFirstName, inputExperience));
            }
        }
    }
    ...
    public void searchContactByExp(ArrayList<Employees> list){
    ...
    public void searchContactByName(ArrayList<Employees> list){
    ...
    public void searchContactById(ArrayList<Employees> list){
